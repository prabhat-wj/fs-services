<header id="header" class="header nav-on-banner">
                ...
                <div class="col-md-6 col-sm-6 col-xs-8">
                    <div class="top-right">
                        <ul class="nav navbar-nav">
                            ...
                            <li>Email:- dsdinbandhu@gmail.com</li><!-- class="flaticon-people" -->
    ...
    <div class="main-nav black-opacity-7">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <nav class="navbar navbar-expand-lg navbar-light w-100"> <a class="navbar-brand" href="index.php"><img class="nav-logo" src="images/logo/fs-logo.jpeg" alt="Image not found" height="60px"></a>
						...
						<!-- <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="service.php" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Services</a> -->
						 <!--  <ul class="dropdown-menu">
							<li class="dropdown"> <a class="dropdown-toggle dropdown-item" href="service.html">Services</a>
							  <ul class="dropdown-menu">
								<li><a class="dropdown-item" href="service.html">Services Style-1</a></li>
								<li><a class="dropdown-item" href="service-2.html">Services Style-2</a></li>
								<li><a class="dropdown-item" href="service-3.html">Services Style-3</a></li>
							  </ul>
							</li>
